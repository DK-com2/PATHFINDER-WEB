...
今あなたが見ているPathfinder Webは、実はもっと大きな夢の入り口なんです。

**Google Mapに頼らない、自分だけのライフログを作りたい**  
正直に言うと、Google Mapの位置履歴って便利だけど、なんだか「借り物」な感じがしませんか？データはGoogleのもので、いつサービスが変わるかもわからない。だから、自分の移動記録は自分でコントロールできるシステムを作りたいと思っています。
